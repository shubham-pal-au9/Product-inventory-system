...
import './displaycategorymobile.css';
const DisplayCategoryMobile = (props) => {

    const DeleteProduct =(ID) => {
        console.log(ID)
        fetch(`http://localhost:9700/deleteMobile/${ID}`,{
            method:'DELETE',
            headers:{
                    ...
                    <div>
                        ...
                        <div class="container">
                            ...
                            <div className="tileComponent2">
                                ...
                                <div class="col-2">
                                 <Link to={`/update-mobile/${item._id}`}> <button className="btn btn-primary">Edit</button> </Link>
    ...
    return(
        <div>
            <div className="quickSearchContainer">
                ...
                <Link to="/add-mobile" className="btn btn-primary">Add Product</Link> <br/> <br/>
...
export default DisplayCategoryMobile;
